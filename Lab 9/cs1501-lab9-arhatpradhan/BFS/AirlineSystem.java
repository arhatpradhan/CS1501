  ...
  private void shortestHops() {
    if(G == null){
      ...
      if(!G.marked[destination]){
        ...
        System.out.print("The shortest route from " + cityNames[source] + " to " 
                        + cityNames[destination] + " has " + G.distTo[destination] + " hop(s): " + cityNames[source] + " ");
        ...
        while (!shortestPath.isEmpty()){
			    System.out.print(cityNames[shortestPath.pop()] + " ");
        }
        System.out.println();
      }
      System.out.print("Please press ENTER to continue ...");
